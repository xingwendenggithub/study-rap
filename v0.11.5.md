...
- [RAP v0.11.5 权限控制&团队管理 设计文档](#rap-v0115-%E6%9D%83%E9%99%90%E6%8E%A7%E5%88%B6&%E5%9B%A2%E9%98%9F%E7%AE%A1%E7%90%86-%E8%AE%BE%E8%AE%A1%E6%96%87%E6%A1%A3)
  - [# RAP v0.11.5 权限控制&团队管理 设计文档](#-rap-v0115-%E6%9D%83%E9%99%90%E6%8E%A7%E5%88%B6&%E5%9B%A2%E9%98%9F%E7%AE%A1%E7%90%86-%E8%AE%BE%E8%AE%A1%E6%96%87%E6%A1%A3)
...
# RAP v0.11.5 权限控制&团队管理 设计文档
----------------
| 版本 | 更新时间 | 备注 |
| ---- | ------- | :--- |
| v0.1.0 | 2015/10/09 | 初稿 |
| v0.1.1 | 2015/10/10 | 完善团队管理部分 |

## 背景
现外网部署的RAP Server越来越多，安全及权限控制非常重要。因此前我们主要考虑内网部署RAP服务器的情况，在权限管理上做的非常弱，本次升级将增强权限管理、提升安全性。增加团队管理，权限控制等功能。使RAP具备部署到公网使用的条件。

## 需求设计
1. 增加团队管理，可设置团队管理员（参考GitHub的Owner/Master/Developer）
2. 可见性调整：不再使所有项目公开，必须加入到团队后（团队管理员负责管理），才能看到该团队下的业务线、分组及项目。
3. 项目访问权限无太大变化，改写文档必须是项目成员或创建者，团队成员可以访问该团队下的所有项目，仅限只读权限。（后续根据需要增加私密项目）
4. 数据仅对平台管理员可见
